...
from submission.algos import hierarchical, augmented_dqn
from submission.utils import postprocessing, miscellaneous
...
DEFAULT_CONFIG = merge_dicts(
    hierarchical.DEFAULT_CONFIG,
    {
        ...
        "opp_policy_id": None,
        "callbacks": None,
        # One from submission.utils.postprocessing.WELFARES
