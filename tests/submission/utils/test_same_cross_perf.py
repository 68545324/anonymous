...
from submission.meta_game_experiments.utils.pg_ipd import get_rllib_config
from submission.utils import log, miscellaneous, restore, cross_play
from submission.utils.miscellaneous import get_random_seeds
...
def test__produce_config_variations():
    ...
    def assert_(n_same_play_per_checkpoint, n_cross_play_per_checkpoint):
        ...
        (
            ...
            all_metadata,
        ) = evaluator._produce_config_variations_from_ckpt(
